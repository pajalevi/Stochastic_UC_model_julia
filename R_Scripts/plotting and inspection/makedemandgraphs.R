# makedemandgraphs.R
# Feb 2019
# contains defn for fn makedemandgraphs()
# which creates a set of graphs about demand and production
# for each unique period/run
# and can be used in a for loop to make graphs of all periods
# Patricia Levi
...
makedemandgraphs = function(default_in_fol,instance_in_fol,output_fol,periodID,stochID, outputID){
  ...
  #TODO: find a better way of identifying the relevant timeperiods than this
...
makemultidemandgraphs = function(default_in_fol,instance_in_fol,output_fol,stochID, outputID){
  # depends on loadTimeseriesData()
  ...
  # slow_commit = read_csv(file = paste0(output_fol,"slow_commitment.csv"))
  fastprod = loadTimeseriesData(output_fol, "fast_production", overlaplength)
  slowprod = loadTimeseriesData(output_fol, "slow_production", overlaplength)
  slowprod$speed = "slow"
  fastprod$speed = "fast"
